...
setup(
    ...
    install_requires=["matplotlib==3.5.1", "networkx==2.8.6", "numpy==1.21.5", "pexpect==4.8.0", "PyYAML==6.0", "scipy==1.8.0", "setuptools==59.6.0", "turbomoleio @ git+https://github.com/wladerer/turbomoleio"],
